...
public class MySecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.formLogin()
                ...
                .antMatchers("/counter").hasAnyAuthority("SystemAdminGroup", "CommonGroup", "SuperUserGroup")
                .antMatchers("/order").hasAnyAuthority("SystemAdminGroup", "CommonGroup", "SuperUserGroup")
                .antMatchers("/task").hasAnyAuthority("SystemAdminGroup", "CommonGroup", "SuperUserGroup")
                .antMatchers("/task/person").hasAnyAuthority("SystemAdminGroup", "CommonGroup", "SuperUserGroup")
                .antMatchers("/task/team").hasAnyAuthority("SystemAdminGroup", "CommonGroup", "SuperUserGroup")
                .antMatchers("/kpi").hasAnyAuthority("SystemAdminGroup", "CommonGroup", "SuperUserGroup")
                .antMatchers("/kpi/team").hasAnyAuthority("SystemAdminGroup", "CommonGroup", "SuperUserGroup")
                .anyRequest()
                .authenticated()
                .and()
            .logout()

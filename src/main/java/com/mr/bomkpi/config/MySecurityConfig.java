...
public class MySecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.formLogin()
                ...
                .antMatchers("/task","/task/**").hasAnyAuthority("SystemAdminGroup", "CommonGroup", "SuperUserGroup")
                ...
                .antMatchers("/kpi","/kpi/**").hasAnyAuthority("SystemAdminGroup", "CommonGroup", "SuperUserGroup")
